...
Pod::Spec.new do |s|
  ...
  s.source            = { :git => "https://githubent.sybrin.com/sybrin-innovations/Sybrin.iOS.SDK.Identity.git", :tag => s.version }
...
s.dependency 'GoogleMLKit/FaceDetection','~> 2.0.0'
s.dependency 'GoogleMLKit/TextRecognition','~> 2.0.0'
s.dependency 'Sybrin.iOS.Common','5.2.19'
end
